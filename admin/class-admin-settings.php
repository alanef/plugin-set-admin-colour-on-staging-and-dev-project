	...
	public function meta_box_info() {
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
					<?php _e( '<p>There is no free support at all.  You can log issues on  <a class="button-secondary" href="https://github.com/alanef/plugin-set-admin-colour-on-staging-and-dev-project/issues/" target="_blank">GitHub here</a></p>
', 'set-admin-colour-on-staging-and-dev' );
					?>
                </td>
            </tr>
